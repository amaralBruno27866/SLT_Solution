...
public:
    ...
    void setupUi(QWidget *ClientForm)
    {
        ...
        ClientForm->resize(735, 558);
        verticalLayout = new QVBoxLayout(ClientForm);
        verticalLayout->setObjectName("verticalLayout");
        page_title = new QLabel(ClientForm);
        ...
        personalInformationBox = new QGroupBox(ClientForm);
        ...
        addressBox = new QGroupBox(ClientForm);
        ...
        frameCreationModification = new QFrame(ClientForm);
        ...
        btRegister = new QToolButton(ClientForm);
...
""));
        ...
        btMyCases = new QToolButton(ClientForm);
...
"}"));
        ...
        btCancel = new QToolButton(ClientForm);
...
""));
    ...
    void retranslateUi(QWidget *ClientForm)
    {
        ...
        page_title->setText(QCoreApplication::translate("ClientForm", "Page Title", nullptr));
        personalInformationBox->setTitle(QCoreApplication::translate("ClientForm", "Personal Information", nullptr));
        firstNameLabel->setText(QCoreApplication::translate("ClientForm", "First name", nullptr));
        lastNameLabel->setText(QCoreApplication::translate("ClientForm", "Last name", nullptr));
        phoneNumberLabel->setText(QCoreApplication::translate("ClientForm", "Phone number", nullptr));
        emailLabel->setText(QCoreApplication::translate("ClientForm", "Email", nullptr));
        addressBox->setTitle(QCoreApplication::translate("ClientForm", "Address", nullptr));
        streetLabel->setText(QCoreApplication::translate("ClientForm", "Street", nullptr));
        cityLabel->setText(QCoreApplication::translate("ClientForm", "City", nullptr));
        label->setText(QCoreApplication::translate("ClientForm", "Province", nullptr));
        provinceCbBox->setItemText(0, QCoreApplication::translate("ClientForm", "N/A", nullptr));
        provinceCbBox->setItemText(1, QCoreApplication::translate("ClientForm", "Alberta (AB)", nullptr));
        provinceCbBox->setItemText(2, QCoreApplication::translate("ClientForm", "British Columbia (BC)", nullptr));
        provinceCbBox->setItemText(3, QCoreApplication::translate("ClientForm", "Manitoba (MB)", nullptr));
        provinceCbBox->setItemText(4, QCoreApplication::translate("ClientForm", "New Brunswick (NB)", nullptr));
        provinceCbBox->setItemText(5, QCoreApplication::translate("ClientForm", "Newfoundland and Labrador (NL)", nullptr));
        provinceCbBox->setItemText(6, QCoreApplication::translate("ClientForm", "Nova Scotia (NS)", nullptr));
        provinceCbBox->setItemText(7, QCoreApplication::translate("ClientForm", "Ontario (ON)", nullptr));
        provinceCbBox->setItemText(8, QCoreApplication::translate("ClientForm", "Prince Edward Island (PE) ", nullptr));
        provinceCbBox->setItemText(9, QCoreApplication::translate("ClientForm", "Quebec (QC)", nullptr));
        provinceCbBox->setItemText(10, QCoreApplication::translate("ClientForm", "Saskatchewan (SK)", nullptr));
        provinceCbBox->setItemText(11, QCoreApplication::translate("ClientForm", "Northwest Territories (NT)", nullptr));
        provinceCbBox->setItemText(12, QCoreApplication::translate("ClientForm", "Nunavut (NU)", nullptr));
        provinceCbBox->setItemText(13, QCoreApplication::translate("ClientForm", "Yukon (YT)", nullptr));

        provinceCbBox->setCurrentText(QCoreApplication::translate("ClientForm", "N/A", nullptr));
        postalCodeLabel->setText(QCoreApplication::translate("ClientForm", "Postal Code", nullptr));
        ModifiedAtLabel->setText(QCoreApplication::translate("ClientForm", "Modified at", nullptr));
        CreatedAtLabel->setText(QCoreApplication::translate("ClientForm", "Created at", nullptr));
        btRegister->setText(QCoreApplication::translate("ClientForm", "Register", nullptr));
        btMyCases->setText(QCoreApplication::translate("ClientForm", "My Cases", nullptr));
        btCancel->setText(QCoreApplication::translate("ClientForm", "Cancel", nullptr));
    } // retranslateUi
